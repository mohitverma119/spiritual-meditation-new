    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          {/* Contact Form */}
          <div className="bg-black-950/60 backdrop-blur-sm border border-white/10 p-6 md:p-8 rounded-xl transition-transform hover:-translate-y-1 duration-300">
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="bg-black-800 border-white/10 text-white placeholder:text-white/50 focus:border-gold-500 focus-visible:ring-gold-500/20"
                  />
                </div>
                <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  rows={5}
                  className="bg-black-800 border-white/10 text-white placeholder:text-white/50 focus:border-gold-500 focus-visible:ring-gold-500/20 resize-none"
                />
              </div>

              <Button
                type="submit"
                className="w-full bg-gradient-to-r from-gold-500 to-gold-600 hover:from-gold-600 hover:to-gold-700 text-black-950 font-medium rounded-full"
              >
                Send Message
              </Button>
            </form>
          ...
          <div className="space-y-4">
            <div className="bg-black-950/60 backdrop-blur-sm border border-white/10 p-6 md:p-8 rounded-xl transition-transform hover:-translate-y-1 duration-300">
              <div className="flex items-start">
                <div className="mr-4 p-3 rounded-full bg-gradient-to-br from-gold-500/20 to-purple-500/20">
                  <Mail className="w-6 h-6 text-white" />
                </div>
                <div>
                  <h4 className="text-xl font-semibold mb-2 text-white">Email Us</h4>
                  <p className="text-white/80 mb-2">
                    For general inquiries and booking information:
                  </p>
                  <a
                    href="mailto:info@wildworldwanderers.com"
                    className="text-gold-500 hover:text-gold-400 transition-colors inline-block"
                  >
            ...
            <div className="bg-black-950/60 backdrop-blur-sm border border-white/10 p-6 md:p-8 rounded-xl transition-transform hover:-translate-y-1 duration-300">
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="text-xl font-semibold mb-2 text-white">Visit Us</h4>
                  <p className="text-white/80 mb-2">
                    Our Himalayan Base:
                  </p>
